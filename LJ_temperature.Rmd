...
Set Temperature: 1.5C    
Thermostat Position: Middle, air, close to shelf   
Logger 1: Water    
Logger 2: Water    
Comments: Thermostat is about 7cm above the shelf. Tempterature loggers pressed down in the water beaker.
...
logger1 <- ("LJ_20180607_L1_1_w.csv")
logger2 <- ("LJ_20180607_L2_1_w.csv")
```
