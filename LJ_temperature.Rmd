...
Logger 1: Water    
Logger 2: Water    
Comments: Thermostat is about 11cm above the shelf. Tempterature loggers pressed down in the water beaker.
Water leaked into the loggers, fridge was opened a few times.. measurement not good. 
...
logger1 <- ("LJ_20180612_L1_1_w.csv")
logger2 <- ("LJ_20180612_L2_1_w.csv")
```
